...
export function fieldKindOf(type: FieldType): FieldKind {
  return DISPLAY_FIELD_TYPES.includes(type) ? "display" : "input";
}
...
export const DEFAULT_ITEM_W = 4;
export const DEFAULT_ITEM_H = 3;
